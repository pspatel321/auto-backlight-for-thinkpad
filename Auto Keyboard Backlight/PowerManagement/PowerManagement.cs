...
namespace Auto_Keyboard_Backlight.PowerManagement
{
    ...
    public partial class PowerGuid
    {
        ...
        public void RaiseNotified(object data)
        {
            Notified?.Invoke(this, new PowerGuidEventArgs(data));
        }
    }
    ...
    public class PowerManagement : FrameworkElement
    {
        ...
        /// <summary>
        /// Register new PowerGuid objects to start receiving messages
        /// </summary>
        ...
        {
            if (_hwnd == IntPtr.Zero) throw new Exception("Window not ready");
            if (guids == null) guids = RegisteredGuids;
            foreach (PowerGuid g in guids)
            {
                IntPtr handle = IntPtr.Zero;
