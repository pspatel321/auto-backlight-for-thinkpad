...
{
    /// <summary>
    /// Backend in order to use unmanaged Win32 <a href="https://docs.microsoft.com/en-us/windows/win32/power/power-management-portal">Power Management API</a> from User32.dll
    /// </summary>
...
#pragma warning disable CS0649 
        ...
        {
            public Guid guidPowerSetting;
            public DWORD dwDataLength;
            public byte[] bData;
        }
...
#pragma warning restore CS0649 
        ...
        internal static extern HPOWERNOTIFY RegisterPowerSettingNotification(HANDLE hRecipient, [MarshalAs(UnmanagedType.LPStruct), In] Guid PowerSettingGuid, DWORD dwFlags);

        [DllImport("user32.dll", SetLastError = true)]
        internal static extern HPOWERNOTIFY RegisterSuspendResumeNotification(HANDLE hRecipient, DWORD dwFlags);

        [DllImport("user32.dll", SetLastError = true)]
        internal static extern BOOL UnregisterPowerSettingNotification(HPOWERNOTIFY Handle);

        [DllImport("user32.dll", SetLastError = true)]
        internal static extern BOOL UnregisterSuspendResumeNotification(HPOWERNOTIFY Handle);
    }

    /// <summary>
    /// List many preconfigured Guids pulled from WinNT.h
    /// </summary>
