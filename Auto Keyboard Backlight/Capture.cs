...
using Auto_Keyboard_Backlight.RawInput;
using System;
        ...
        public bool Enabled
        {
            ...
            set
            {
                if (_enabled != value)
                {
                    ...
                    if (value)
                    {
                        _ri.RegisterDeviceCollections(new List<DeviceCollection> { _keyboardColl, _mouseColl, _touchpadColl });
                    }
                    else
                    {
                        _ri.UnregisterDeviceCollections(new List<DeviceCollection> { _keyboardColl, _mouseColl, _touchpadColl });
                    }
                }
            }
        }
