...
namespace Auto_Backlight_for_ThinkPad
{
    public partial class Settings : INotifyPropertyChanged
    {
        ...
        {
            Meta = new Metadata(
                                Keyboard_Enabled:new Metadata<bool>(def:true, min:false, max:true, unit:"", help:"Enable automatic keyboard backlight control with user activity timeout"), 
                                Keyboard_InactivityTimeout:new Metadata<double>(def:60, min:1, max:double.PositiveInfinity, unit:"s", help:"Keyboard backlight timeout after user inactivity"), 
                                Keyboard_OnLevel:new Metadata<int>(def:2, min:0, max:2, unit:"", help:"Keyboard backlight brightness level"), 
                                Screen_Enabled:new Metadata<bool>(def:true, min:false, max:true, unit:"", help:"Enable automatic screen brightness control with ambient light level from webcam image"), 
                                Screen_PollPeriod:new Metadata<double>(def:double.PositiveInfinity, min:1, max:double.PositiveInfinity, unit:"s", help:"Screen brightness refresh period from webcam image"), 
                                Screen_HotKeyEnabled:new Metadata<bool>(def:true, min:false, max:true, unit:"", help:"Enable a hotKey to trigger manual screen brightness refresh"), 
                                Screen_HotKey:new Metadata<string>(def:"Alt + Space", min:default, max:default, unit:"", help:"HotKey to trigger manual screen brightness refresh"), 
                                Screen_LearnedPoints:new Metadata<List<Tuple<double,double>>>(def:new List<Tuple<double,double>>{ new Tuple<double,double>(0.00,0.10), new Tuple<double,double>(0.10,0.65), new Tuple<double,double>(0.35,0.95), new Tuple<double,double>(1.00,1.00)}, min:null, max:null, unit:"", help:"Screen brightness vs ambient light level calibration curve"), 
                                Screen_Curvature:new Metadata<double>(def:0.5, min:0, max:1, unit:"", help:"Screen brightness vs ambient light level calibration curve, parameter for smoothed spline")
                                );
        ...
        {
            public Metadata(Metadata<bool> Keyboard_Enabled, Metadata<double> Keyboard_InactivityTimeout, Metadata<int> Keyboard_OnLevel, Metadata<bool> Screen_Enabled, Metadata<double> Screen_PollPeriod, Metadata<bool> Screen_HotKeyEnabled, Metadata<string> Screen_HotKey, Metadata<List<Tuple<double,double>>> Screen_LearnedPoints, Metadata<double> Screen_Curvature)
            {
                this.Keyboard_Enabled = Keyboard_Enabled;
                this.Keyboard_InactivityTimeout = Keyboard_InactivityTimeout;
                this.Keyboard_OnLevel = Keyboard_OnLevel;
                this.Screen_Enabled = Screen_Enabled;
                this.Screen_PollPeriod = Screen_PollPeriod;
                this.Screen_HotKeyEnabled = Screen_HotKeyEnabled;
                this.Screen_HotKey = Screen_HotKey;
                this.Screen_LearnedPoints = Screen_LearnedPoints;
                this.Screen_Curvature = Screen_Curvature;
                
                List = new ListView(this);
                Dictionary = new DictionaryView(this);
            }
            public Metadata<bool> Keyboard_Enabled { get; }
            public Metadata<double> Keyboard_InactivityTimeout { get; }
            public Metadata<int> Keyboard_OnLevel { get; }
            public Metadata<bool> Screen_Enabled { get; }
            public Metadata<double> Screen_PollPeriod { get; }
            public Metadata<bool> Screen_HotKeyEnabled { get; }
            public Metadata<string> Screen_HotKey { get; }
            public Metadata<List<Tuple<double,double>>> Screen_LearnedPoints { get; }
            public Metadata<double> Screen_Curvature { get; }
