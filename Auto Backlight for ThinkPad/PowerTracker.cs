...
using Auto_Backlight_for_ThinkPad.PowerManagement;
using System;
...
namespace Auto_Backlight_for_ThinkPad
{
    ...
    public class PowerTracker
    {
        ...
        public bool Enabled
        {
            ...
            set
            {
                if (_enabled != value)
                {
                    ...
                    if (value)
                    {
                        _pm.RegisterGuids(new PowerGuid[] { _dispEvent, _lidEvent, _suspendEvent, _resumeEvent });
                    }
                    else
                    {
                        _pm.UnregisterGuids();
        ...
        public PowerTracker(PowerManagement.PowerManagement pm)
        {
            _pm = pm;
